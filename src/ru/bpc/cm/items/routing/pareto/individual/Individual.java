...
public class Individual implements SolutionRoutes {
	...
	public void evaluateRoutes() {	
		...
		for (int i = 1; i < routesNumber; i++) {
			...
			if (!routes.get(i).isFeasible() ||  routes.get(i-1).getDistance() + routes.get(i).getDistance() > sumCost1) { 
...
//	}
    ...
    public String toString() {
    	...
    	str.append("-- ");*/
    	str.append("<"+ paretoRank +"> (" + routesNumber + "; " + totalCost + "; " + isMaxCarsSatisfied + "; " + isMaxCustInRouteSatisfied + "; " + isMaxRouteLengthSatisfied + "; " + isMaxRouteTimeSatisfied + ") "); 	
